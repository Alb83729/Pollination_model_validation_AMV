CopyOfload_expert_tables <- function(path_file_expert_table){
  ...
  HF_table_big_season_4 <- expert_table[,c("code",
                                           "foraging_suitability_big_season_4",
                                           "fl_resource_weight_season_4"
  )] %>%
    rename(foraging_suitability=foraging_suitability_big_season_4,
  ...
  HF_table_small_season_4 <- expert_table[,c("code",
                                             "foraging_suitability_small_season_4",
                                             "fl_resource_weight_season_4"
  )] %>%
    rename(foraging_suitability=foraging_suitability_small_season_4,
           fl_resource_weight=fl_resource_weight_season_4
    ) %>%
    mutate(species="small",
           season = 4)
