source("scripts/text_extract_info_CORINE_v2/config.R")
source("scripts/text_extract_info_CORINE_v2/R/deps.R")
source("scripts/text_extract_info_CORINE_v2/R/io.R")
source("scripts/text_extract_info_CORINE_v2/R/crs.R")
source("scripts/text_extract_info_CORINE_v2/R/parallel.R")
source("scripts/text_extract_info_CORINE_v2/R/lonsdorf_site.R")
